    ...
    <>
      ...
      {bookmarks.length === 0 ? (
        <div className="min-h-[70vh] flex items-center justify-center flex-col gap-1 sm:gap-3 text-center">
          <h1 className="text-xl sm:text-2xl font-bold">You have no bookmarks yet.</h1>
          <p className="text-lg sm:text-xl font-semibold">Start adding your favourite news items to see them here.</p>
        </div>
      ) : (
        <NewsList
